...
#define BIFROST_PLUGIN_STRING_TO_IDENTIFIER {"bifrost_add", Plugin::Identifier::bifrost_add},
...
#define bifrost_add_func \
  ((int (*)(int, int))BIFROST_NAMESPACE_UNQUALIFIED(Plugin::Get)().GetHook<BIFROST_NAMESPACE_UNQUALIFIED(Plugin::Identifier::bifrost_add)>()->GetOriginal())
